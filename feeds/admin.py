...
class SourceAdmin(admin.ModelAdmin):
    ...
    def posts_link(self, obj=None):
        ...
        qs = obj.posts.all()
        return mark_safe(
            '<a href="/admin/feeds/post/?source__id=%i" target="_blank">%i Posts</a>'
            % (obj.id, qs.count())
        )
...
class PostAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("enclosures_link",)
    ...
    def enclosures_link(self, obj=None):
        ...
        return mark_safe(
            '<a href="/admin/feeds/enclosure/?post__id=%i" target="_blank">%i Enclosures</a>'
            % (obj.id, qs.count())
        )
